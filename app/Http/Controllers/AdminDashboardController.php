...
class AdminDashboardController extends Controller
{
    ...
    {
        $registration = GurukulRegistration::paginate(10);
        $registration->delete();
    ...
    {
        $gurukuls = GurukulRegistration::paginate(10);
        $teacher = TeacherRegistration::paginate(10);
    ...
    {   
        ...
        $gurukuls = GurukulRegistration::paginate(10);
        $student = StudentRegistration::paginate(10);
    ...
    public function showStdClass()
    {
        ...
        $std_class = Add_student_class::all();
