...
<div class="container">
    <div class="box">
        <a class="button" href="#popup1" onclick="('add')">Add New School</a>
    </div>
   <!-- Gurukul List Table -->
   <h1 class="text-center">Gurukul Registration Page</h1>
    ...
    <div id="popup1" class="overlay">
        <div class="popup">
            ...
            <div class="content">
                <form id="gurukulForm" action="{{ route('gurukul.register') }}" method="POST" class="gurukul registration">
                    @csrf
                    <!-- Hidden input to track whether it's edit or add -->
                    <input type="hidden" id="gurukul_id" name="gurukul_id" value="">

                    <!-- Gurukul Name -->
                    <div class="mb-3 center">
                        <input type="text" id="gurukul_name" name="gurukul_name" placeholder="Gurukul Name" class="form-control" required>
                    </div>

                    <!-- Address -->
                    <div class="mb-3 center">
                        <textarea id="address" name="address" class="form-control" placeholder="Address (including Pincode)" rows="3" required></textarea>
                    </div>
                    ...
                    <div class="mb-3 center">
                        ...
                        <select id="type_of_setup" name="setup_type" class="form-select form-control">
                    ...
                    <div class="mb-3 center">
                        ...
                        <select id="focus_area" name="focus_area[]" class="form-select form-control" multiple>
                    ...
                    <div class="mb-3 center">
                        ...
                        <br>
                        <input type="text" id="education_board_name" name="education_board_name" class="form-control">
                    </div>

                    <button type="submit" id="submit-button" class="btn btn-primary center">Submit</button>
                </form>
            </div>
        </div>
    </div>
...
<div id="popup2" class="overlay">
    <div class="popup">
        ...
        <a class="close" href="#">&times;</a>
        <div class="content">
            <form id="gurukulForms" action="{{ route('gurukul.register') }}" method="POST" class="gurukul registration">
                @csrf
                <!-- Hidden input to track whether it's edit or add -->
                ...
                <button type="submit" id="submit-buttons" class="btn btn-primary center">Update</button>
            </form>
        </div>
    </div>
</div>
